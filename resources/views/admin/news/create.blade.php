    ...
    <form action="{{ route('admin.news.store') }}" class="form" id="kt_form" method="POST" enctype="multipart/form-data">
        ...
        <div class="card-body">
            <div class="mb-2 mx-2">
                ...
                <input type="date" id="date" name="date" class="form-control" value="@php echo date('Y-m-d'); @endphp" />
            </div>
            <div class="col-xl-12">
                ...
                <div class="tab-content mt-5">
                    ...
                    <div class="tab-pane fade {{ $language['code'] == 'tr' ? 'active show' : '' }}" id="kt_tab_pane_{{$language["code"]}}_2" role="tabpanel">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="title_{{$language["code"]}}" name="title_{{$language["code"]}}" value="{{ old('title_' . $language["code"]) }}" class="form-control" placeholder="Haber başlığını giriniz" />
                        </div>
                        <div class="form-group">
                            <label for="content_{{$language["code"]}}">Haber İçeriği ({{$language['name']}}) <span class="text-danger">*</span></label>
                            <textarea type="text" class="ckeditor" id="ckeditor1" name="content_{{$language["code"]}}" value="{{ old('content_' . $language["code"]) }}" class="form-control" rows="5"></textarea>
                        </div>
                    </div>
