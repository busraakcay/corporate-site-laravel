                            ...
                            <div class="layer-content">
                                ...
                                <div class="section-title style2">
                                    <div class="title-header">
                                        ...
                                        <h2 class="title">{{ __("Our Contact Information") }}</h2>
                                    </div>
                                ...
                                <a href="https://wa.me/905551234567" class="mt-5 submit ttm-btn ttm-btn-size-md ttm-btn-shape-square ttm-btn-style-fill ttm-btn-color-skincolor" target="_blank">
                        ...
                        <div class="ttm-col-bgcolor-yes ttm-bg ttm-bgcolor-skincolor spacing-2">
                            <div class="layer-content">
                                ...
                                <ul class="ttm_contact_widget_wrapper">
                                    <li><i class="fa fa-map-marker"></i>{{$settings->company_address}}</li>
                                    <li><i class="fa fa-phone"></i>{{$settings->company_phone}}</li>


                                    <li><i class="fa fa-envelope-o"></i>{{$settings->company_email}}</li>
                                </ul>
