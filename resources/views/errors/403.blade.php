...
<head>
		...
		<meta charset="utf-8" />
		<title>403 | {{__("I think you're lost !")}}</title>
		<meta name="description" content="" />
		<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no" />
		<link rel="canonical" href="https://keenthemes.com/metronic" />
		<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Poppins:300,400,500,600,700" />
		<link href="{{asset('assets/panel/css/pages/error/error-315aa.css?v=7.2.2')}}" rel="stylesheet" type="text/css" />
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="error error-3 d-flex flex-row-fluid bgi-size-cover bgi-position-center" style="background-image: url({{asset('assets/panel/media/error/bg3.jpg);')}}">
				...
				<div class="px-10 px-md-30 py-10 py-md-0 d-flex flex-column justify-content-md-center">
					...
					<p class="display-4 font-weight-boldest text-white mb-12">{{__("I think you're lost !")}}</p>
					<p class="font-size-h1 font-weight-boldest text-dark-75">{{__('You are not authorized to enter here!')}}</p>
